const WorkoutPage = (function () {
  ...
  const jt    = (cx,cy,r=3)        => `<circle cx="${cx}" cy="${cy}" r="${r}" class="sf-joint"/>`;
  const gnd   = (y=112)            => `<line x1="8" y1="${y}" x2="72" y2="${y}" class="sf-ground"/>`;
  ...
  const FIGS = {
    ...
    squat: fig('squat',[
      ...
      head(40,14) +
      ln(40,23,40,58) +
      ln(40,35,25,50) + ln(40,35,55,50) +
      ln(40,58,28,82) + ln(40,58,52,82) +
      ln(28,82,28,105) + ln(52,82,52,105) +
      jt(40,35) + jt(25,50) + jt(55,50) + jt(40,58) + jt(28,82) + jt(52,82) +
      gnd(112),
      // Frame B: deep squat
      head(40,16) +
      ln(40,25,40,52) +
      ln(40,36,20,28) + ln(40,36,60,28) +
      ln(40,52,20,74) + ln(40,52,60,74) +
      ln(20,74,28,96) + ln(60,74,52,96) +
      jt(40,36) + jt(20,28) + jt(60,28) + jt(40,52) + jt(20,74) + jt(60,74) +
      gnd(105),
    ]),
    ...
    pushup: fig('pushup',[
      ...
      ln(18,36,50,38) +
      ln(50,38,68,38) +
      ln(28,38,28,58) + ln(42,38,42,58) +
      ln(68,38,72,58) +
      jt(28,38) + jt(42,38) + jt(28,58) + jt(42,58) + jt(50,38) + jt(68,38),
      // Frame B: down position
      head(18,40,8) +
      ln(18,48,50,54) +
      ln(50,54,68,54) +
      ln(28,54,24,68) + ln(42,54,46,68) +
      ln(68,54,72,68) +
      jt(28,54) + jt(42,54) + jt(24,68) + jt(46,68) + jt(50,54) + jt(68,54),
    ]),
    ...
    plank: fig('plank',[
      ...
      ln(62,42,66,60) +
      jt(30,41) + jt(28,62) + jt(44,41) + jt(46,62) + jt(62,42) + jt(66,60),
      head(12,32,8) +
      ln(12,40,62,46) +
      ln(30,41,28,62) + ln(44,42,46,62) +
      ln(62,46,66,62) +
      jt(30,41) + jt(28,62) + jt(44,42) + jt(46,62) + jt(62,46) + jt(66,62),
    ]),
    ...
    lunge: fig('lunge',[
      ...
      jt(40,35) + jt(24,46) + jt(56,46) + jt(40,52) + jt(24,75) + jt(56,75) +
      gnd(107),
      head(40,14) +
      ln(40,23,40,52) +
      ...
      jt(40,35) + jt(56,46) + jt(24,46) + jt(40,52) + jt(56,75) + jt(24,75) +
      gnd(107),
    ]),
    ...
    bridge: fig('bridge',[
      ...
      ln(60,78,70,55) +
      ln(70,55,68,32) +
      ln(40,97,18,100) + ln(18,100,14,75) +
      jt(40,97) + jt(60,78) + jt(70,55) + jt(18,100),
      head(40,108,8) +
      ln(40,100,68,72) +
      ln(68,72,66,45) +
      ln(66,45,64,22) +
      ln(40,100,16,102) + ln(16,102,12,78) +
      jt(40,100) + jt(68,72) + jt(66,45) + jt(16,102),
    ]),
    ...
    crunch: fig('crunch',[
      ...
      ln(60,40,76,58) +
      ln(76,58,68,80) +
      ln(14,36,10,52) + ln(10,52,16,68) +
      jt(14,36) + jt(60,40) + jt(76,58) + jt(10,52) +
      gnd(82),
      head(22,20,8) +
      ln(22,28,62,44) +
      ln(62,44,74,62) +
      ...
      jt(22,28) + jt(62,44) + jt(74,62) + jt(14,44) +
      gnd(87),
    ]),
    ...
    jumpjack: fig('jumpjack',[
      ...
      jt(40,35) + jt(30,50) + jt(50,50) + jt(40,58) + jt(36,85) + jt(44,85) +
      gnd(112),
      head(40,14) +
      ln(40,23,40,58) +
      ln(40,35,16,22) + ln(40,35,64,22) +
      ln(40,58,22,80) + ln(40,58,58,80) +
      ln(22,80,16,105) + ln(58,80,64,105) +
      jt(40,35) + jt(16,22) + jt(64,22) + jt(40,58) + jt(22,80) + jt(58,80) +
      gnd(112),
    ]),
    ...
    highknees: fig('highknees',[
      head(40,14) +
      ln(40,23,40,55) +
      ln(40,35,24,50) + ln(40,35,56,28) +
      ln(40,55,28,72) + ln(28,72,26,58) +
      ln(40,55,54,78) + ln(54,78,56,105) +
      jt(40,35) + jt(24,50) + jt(56,28) + jt(40,55) + jt(28,72) + jt(54,78) +
      gnd(112),
      head(40,14) +
      ln(40,23,40,55) +
      ...
      jt(40,35) + jt(56,50) + jt(24,28) + jt(40,55) + jt(52,72) + jt(26,78) +
      gnd(112),
    ]),
    ...
    burpee: fig('burpee',[
      ...
      jt(40,30) + jt(20,14) + jt(60,14) + jt(40,52) + jt(32,80) + jt(48,80) +
      gnd(112),
      head(12,32,8) +
      ln(12,40,62,42) +
      ln(30,41,28,62) + ln(44,41,46,62) +
    ...
    climber: fig('climber',[
      ...
      ln(60,42,52,65) + ln(52,65,50,88) +
      ln(60,42,68,68) + ln(68,68,70,95) +
      jt(30,40) + jt(44,41) + jt(28,60) + jt(46,61) + jt(60,42) + jt(52,65) + jt(68,68),
      head(12,30,8) +
      ln(12,38,60,42) +
      ln(30,40,28,60) + ln(44,41,46,61) +
      ln(60,42,68,65) + ln(68,65,70,88) +
      ln(60,42,50,68) + ln(50,68,48,95) +
      jt(30,40) + jt(44,41) + jt(28,60) + jt(46,61) + jt(60,42) + jt(68,65) + jt(50,68),
    ]),
    ...
    twist: fig('twist',[
      head(40,18) +
      ln(40,26,40,58) +
      ln(40,38,18,32) + ln(40,38,50,30) +
      ln(40,58,30,80) + ln(40,58,50,80) +
      ln(30,80,28,108) + ln(50,80,52,108) +
      jt(40,38) + jt(18,32) + jt(50,30) + jt(40,58) + jt(30,80) + jt(50,80) +
      gnd(112),
      head(40,18) +
      ln(40,26,40,58) +
      ...
      ln(40,58,30,80) + ln(40,58,50,80) +
      ln(30,80,28,108) + ln(50,80,52,108) +
      jt(40,38) + jt(50,32) + jt(18,30) + jt(40,58) + jt(30,80) + jt(50,80) +
      gnd(112),
    ]),
    ...
    sideplank: fig('sideplank',[
      ...
      ln(62,58,70,48) +
      ln(62,58,64,85) +
      jt(30,32) + jt(28,52) + jt(62,58) + jt(70,48) + jt(64,85),
      head(20,20,8) +
      ln(20,28,62,62) +
      ln(30,34,28,54) +
      ln(62,62,70,52) +
      ln(62,62,64,88) +
      jt(30,34) + jt(28,54) + jt(62,62) + jt(70,52) + jt(64,88),
    ]),
    ...
    bicycle: fig('bicycle',[
      head(38,20,8) +
      ln(38,28,44,58) +
      ln(44,58,62,75) + ln(62,75,60,98) +
      ln(44,58,24,78) + ln(24,78,26,62) +
      ln(38,28,20,22) + ln(38,28,58,34) +
      jt(38,28) + jt(44,58) + jt(62,75) + jt(24,78) + jt(20,22) + jt(58,34),
      head(42,20,8) +
      ln(42,28,36,58) +
      ln(36,58,18,75) + ln(18,75,20,98) +
      ln(36,58,56,78) + ln(56,78,54,62) +
      ln(42,28,60,22) + ln(42,28,22,34) +
      jt(42,28) + jt(36,58) + jt(18,75) + jt(56,78) + jt(60,22) + jt(22,34),
    ]),
    ...
    legraise: fig('legraise',[
      ...
      jt(40,35) + jt(24,50) + jt(56,50) + jt(40,60) + jt(32,88) + jt(48,88),
      head(40,14,8) +
      ln(40,22,40,60) +
      ln(40,35,24,50) + ln(40,35,56,50) +
      ln(40,60,30,38) + ln(40,60,50,38) +
      ln(30,38,28,18) + ln(50,38,52,18) +
      jt(40,35) + jt(24,50) + jt(56,50) + jt(40,60) + jt(30,38) + jt(50,38),
    ]),
    ...
    deadbug: fig('deadbug',[
      head(40,14,8) +
      ln(40,22,40,58) +
      ln(40,35,62,20) + ln(40,35,22,46) +
      ln(40,58,24,78) + ln(24,78,20,100) +
      ln(40,58,60,72) + ln(60,72,65,50) +
      jt(40,35) + jt(62,20) + jt(22,46) + jt(40,58) + jt(24,78) + jt(60,72),
      head(40,14,8) +
      ln(40,22,40,58) +
      ln(40,35,18,20) + ln(40,35,58,46) +
      ln(40,58,56,78) + ln(56,78,60,100) +
      ln(40,58,20,72) + ln(20,72,15,50) +
      jt(40,35) + jt(18,20) + jt(58,46) + jt(40,58) + jt(56,78) + jt(20,72),
    ]),
    ...
    dip: fig('dip',[
      head(40,14) +
      ln(40,23,40,55) +
      ln(40,35,20,40) + ln(20,40,16,62) +
      ln(40,35,60,40) + ln(60,40,64,62) +
      ln(40,55,32,82) + ln(40,55,48,82) +
      ln(32,82,30,108) + ln(48,82,50,108) +
      jt(40,35) + jt(20,40) + jt(16,62) + jt(60,40) + jt(64,62) + jt(40,55) + jt(32,82) + jt(48,82) +
      gnd(112),
      head(40,22) +
      ln(40,30,40,62) +
      ...
      jt(40,42) + jt(20,40) + jt(16,62) + jt(60,40) + jt(64,62) + jt(40,62) + jt(32,88) + jt(48,88) +
      gnd(112),
    ]),
    ...
    boxstep: fig('boxstep',[
      ...
      ln(40,23,40,55) +
      ln(40,35,24,46) + ln(40,35,56,46) +
      ln(40,55,28,74) + ln(28,74,24,96) +
      ln(40,55,52,80) + ln(52,80,52,108) +
      jt(40,35) + jt(24,46) + jt(56,46) + jt(40,55) + jt(28,74) + jt(52,80) +
      gnd(112),
      head(40,10) +
      ln(40,19,40,52) +
      ...
      jt(40,30) + jt(24,42) + jt(56,42) + jt(40,52) + jt(30,74) + jt(50,74) +
      gnd(100),
    ]),
    ...
    skater: fig('skater',[
      ...
      ln(38,58,26,80) + ln(26,80,22,108) +
      ln(38,58,56,72) + ln(56,72,62,52) +
      jt(38,45) + jt(20,38) + jt(52,38) + jt(38,58) + jt(26,80) + jt(56,72) +
      gnd(112),
      head(52,18) +
      ln(52,26,42,58) +
      ...
      jt(42,45) + jt(60,38) + jt(28,38) + jt(42,58) + jt(54,80) + jt(24,72) +
      gnd(112),
    ]),
    ...
    superman: fig('superman',[
      head(16,34,8) +
      ln(16,42,60,46) +
      ln(16,42,6,28) + ln(6,28,4,18) +
      ln(60,46,70,36) + ln(70,36,76,26) +
      ln(60,46,64,68) + ln(64,68,68,88) +
      jt(16,42) + jt(6,28) + jt(70,36) + jt(60,46) + jt(64,68),
      head(16,32,8) +
      ln(16,40,60,44) +
      ln(16,40,4,24) + ln(4,24,2,14) +
      ln(60,44,72,32) + ln(72,32,78,20) +
      ln(60,44,62,66) + ln(62,66,66,86) +
      jt(16,40) + jt(4,24) + jt(72,32) + jt(60,44) + jt(62,66),
    ]),
    ...
    jumpsquat: fig('jumpsquat',[
      head(40,8) +
      ln(40,17,40,48) +
      ln(40,28,22,18) + ln(40,28,58,18) +
      ln(40,48,32,72) + ln(40,48,48,72) +
      ln(32,72,30,96) + ln(48,72,50,96) +
      jt(40,28) + jt(22,18) + jt(58,18) + jt(40,48) + jt(32,72) + jt(48,72),
      head(40,14) +
      ln(40,23,40,54) +
      ln(40,35,20,28) + ln(40,35,60,28) +
      ln(40,54,20,76) + ln(40,54,60,76) +
      ln(20,76,28,100) + ln(60,76,52,100) +
      jt(40,35) + jt(20,28) + jt(60,28) + jt(40,54) + jt(20,76) + jt(60,76) +
      gnd(107),
    ]),
    ...
    cooldown: fig('cooldown',[
      ...
      jt(40,35) + jt(22,48) + jt(58,48) + jt(40,58) + jt(34,85) + jt(46,85) +
      gnd(112),
      head(40,14) +
      ln(40,23,40,58) +
      ...
      ln(40,58,34,85) + ln(40,58,46,85) +
      ln(34,85,34,108) + ln(46,85,46,108) +
      jt(40,35) + jt(20,26) + jt(60,26) + jt(40,58) + jt(34,85) + jt(46,85) +
      gnd(112),
    ]),
    ...
    warmup: fig('warmup',[
      ...
      jt(40,35) + jt(24,48) + jt(56,26) + jt(40,55) + jt(50,78) + jt(28,72) +
      gnd(112),
      head(40,14) +
      ln(40,23,40,55) +
      ...
      jt(40,35) + jt(56,48) + jt(24,26) + jt(40,55) + jt(30,78) + jt(52,72) +
      gnd(112),
    ]),
  };
