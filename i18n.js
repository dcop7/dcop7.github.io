const I18n = (function () {
  ...
  const T = {
    en: {
      ...
      'st.icons':'Icons','st.icons.desc':'Colourful or monochrome',
      'st.icons.colored':'🌈 Coloured','st.icons.mono':'◾ Mono',
      ...
      'st.games':'Games',
      'st.age':'Default age group','st.age.desc':'Word and puzzle difficulty at startup',
      'st.age.5':'Ages 5–7','st.age.7':'Ages 7–9','st.age.10':'Ages 10–12','st.age.13':'13+',
    ...
    pt: {
      ...
      'st.icons':'Ícones','st.icons.desc':'Coloridos ou monocromáticos',
      'st.icons.colored':'🌈 Coloridos','st.icons.mono':'◾ Mono',
      ...
      'st.games':'Jogos',
      'st.age':'Faixa etária padrão','st.age.desc':'Dificuldade das palavras e desafios ao iniciar',
      'st.age.5':'5–7 anos','st.age.7':'7–9 anos','st.age.10':'10–12 anos','st.age.13':'13+ anos',
