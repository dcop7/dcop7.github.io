const Search = (function () {
  ...
  const SECTIONS = [
    ...
    { label: 'Fitness',      id: 'fitness',          icon: '🤸', tags: ['fitness','alongamentos','stretching','exercício','exercise','treino','workout','flexibilidade','mobilidade','pescoço','costas','pernas','ombros'] },
