const Search = (function () {
  ...
  const SECTIONS = [
    ...
    { label: 'Cidadão',      id: 'cidadao',          icon: '🇵🇹', tags: ['cidadão','cidadao','estado','prazos','deadlines','apoios','benefícios','subsídios','irs','iuc','imi','inspeção','cartão de cidadão','carta de condução','candidaturas','bolsas','porta 65','segurança social','finanças','governo','impostos'] },
    { label: 'Fórmula 1',    id: 'f1',               icon: '🏎️', tags: ['fórmula 1','formula 1','f1','corrida','race','grande prémio','grand prix','gp','pilotos','drivers','campeonato','championship','pista','circuito','automobilismo','motorsport'] },
    { label: 'Fotografia',   id: 'photography',      icon: '📷', tags: ['fotografia','photography','foto','câmara','camera','lentes','objetiva','retrato','paisagem','macro','exposição','iso','abertura','velocidade','obturador'] },
    { label: 'Cheatsheets de Fotografia', id: 'photography/cheatsheets', icon: '📋', tags: ['cheatsheet fotografia','cheatsheets fotografia','luz de retrato','esquemas de luz','rembrandt','butterfly','split','clamshell','high key','low key','velocidade de obturador','shutter speed','que velocidade','balanço de brancos','white balance','medição','histograma','flash','sunny 16','modos','av','tv','triângulo de exposição'] },
  ...
  const GAMES = [
    ...
    { label: 'Sueca',            id: 'games/sueca',          icon: '♠️', tags: ['sueca','cartas','trunfo','bandeira','parceiro'] },
