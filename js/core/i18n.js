const I18n = (function () {
  ...
  const T = {
    en: {
      ...
      'nav.quiz':'Quizzes','nav.humor':'Humour','nav.explorer':'Explore','nav.ocorrencias':'PT Incidents','nav.eventos':'Events','nav.noticias':'News','nav.f1':'Formula 1','nav.oss':'Tech Discovery','nav.discovery':'Product Discovery',
      ...
      'game.battleship':'Battleship','game.uno':'Uno',
    ...
    pt: {
      ...
      'nav.quiz':'Quizzes','nav.humor':'Humor','nav.explorer':'Explorar','nav.ocorrencias':'Ocorrências PT','nav.eventos':'Eventos','nav.noticias':'Notícias','nav.f1':'Fórmula 1','nav.oss':'Descobrir Tech','nav.discovery':'Product Discovery',
      ...
      'game.battleship':'Batalha Naval','game.uno':'Uno',
